...
private val mockTransactionsLight = listOf(
...
fun PreviewPortfolioInDebt() {
    ProgettoMobileTheme {
        PortfolioView(
            ...
            totalCredits = 24.50,
            activeFilter = "ALL",
            transactions = mockTransactionsLight,
            onFilterChange = {},
            userToken = "",
...
fun PreviewPortfolioInCredit() {
    ProgettoMobileTheme {
        PortfolioView(
            ...
            totalCredits = 24.50,
            activeFilter = "ALL",
            transactions = listOf(mockTransactionsLight[0]),
            onFilterChange = {},
            userToken = "",
            onAddClick = { println("Add Clicked") }
        )
...
fun PreviewPortfolioPaid() {
    ProgettoMobileTheme {
        PortfolioView(
            ...
            totalCredits = 24.50,
            activeFilter = "PAID",
            transactions = listOf(mockTransactionsLight[2]),
            onFilterChange = {},
            userToken = "",
            onAddClick = { println("Add Clicked") }
        )
